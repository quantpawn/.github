...
Minimal, research-first, and reproducible.

- Autonomous factor discovery
- MCP-based modeling interfaces
- Feedback-driven strategy iteration
...
See [paper/README.md](paper/README.md) for full build details.
